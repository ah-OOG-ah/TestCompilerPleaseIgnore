...
public enum Operation {
    ...
    public static Operation operationOf(Token t) {
        return switch (t) {
            ...
            default -> throw opEx(t);
        };
    }

    public static IllegalArgumentException opEx(Token t) {
        return new IllegalArgumentException("Could not convert " + t + " into an arithmetic operation!");
    }
}
